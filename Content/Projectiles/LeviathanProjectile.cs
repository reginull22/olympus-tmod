...
namespace olympus.Content.Projectiles
{
	...
	public class LeviathanProjectile : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Color backDarkColor = new Color(45, 133, 200); // Original Excalibur color: Color(180, 160, 60)
			Color middleMediumColor = new Color(105, 202, 226); // Original Excalibur color: Color(255, 255, 80)
			Color frontLightColor = new Color(139, 242, 244); // Original Excalibur color: Color(255, 240, 150)
			...
			DrawPrettyStarSparkle(Projectile.Opacity, SpriteEffects.None, drawPos2, new Color(86, 159, 215, 0) * lerpTime * 0.5f, middleMediumColor, percentageOfLife, 0f, 0.5f, 0.5f, 1f, 0f, new Vector2(2f, Utils.Remap(percentageOfLife, 0f, 1f, 4f, 1f)) * scale, Vector2.One * scale);
